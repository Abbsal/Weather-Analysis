 ...
 "cells": [
  {
   ...
   "outputs": [],
   "source": [
    "# EDA on Weather Dataset Project to answer major questions from the dataset.\n",
    "\n",
    "import pandas as pd"
   ]
  },
  {
   ...
   "outputs": [],
   "source": [
    "dataset = pd.read_csv(r\"C:\\Users\\abhijsal\\Documents\\1. Weather Data.csv\") #r is added to remove unicode error."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [
    {
     "ename": "SyntaxError",
     "evalue": "invalid syntax (4246022830.py, line 1)",
     "output_type": "error",
     "traceback": [
      "\u001b[1;36m  File \u001b[1;32m\"C:\\Users\\abhijsal\\AppData\\Local\\Temp\\ipykernel_21764\\4246022830.py\"\u001b[1;36m, line \u001b[1;32m1\u001b[0m\n\u001b[1;33m    .head\u001b[0m\n\u001b[1;37m    ^\u001b[0m\n\u001b[1;31mSyntaxError\u001b[0m\u001b[1;31m:\u001b[0m invalid syntax\n"
     ]
    }
   ],
   "source": []
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "<bound method DataFrame.value_counts of              Date/Time  Temp_C  Dew Point Temp_C  Rel Hum_%  Wind Speed_km/h  \\\n",
       "0        1/1/2012 0:00    -1.8              -3.9         86                4   \n",
       "1        1/1/2012 1:00    -1.8              -3.7         87                4   \n",
       "2        1/1/2012 2:00    -1.8              -3.4         89                7   \n",
       "3        1/1/2012 3:00    -1.5              -3.2         88                6   \n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Questions to be answered for the dataset.\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    "dataset['Wind Speed_km/h'].nunique()"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "dataset['Wind Speed_km/h'].unique() # These are the unique values of Wind speed column."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "dataset.Weather.value_counts() # weather was clear 1326 times."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "# Groupby\n",
    "\n",
    "dataset.groupby('Weather').get_group('Clear')"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# Find the number of times when the windspeed was exactly 4 Km/h ?"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "dataset[dataset['Wind Speed_km/h'] == 4] # Answer"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "dataset.rename(columns = {'Weather' : 'Weather Condition'})"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# In order to permanently rename the column.\n",
    "\n",
    "dataset.rename(columns = {'Weather' : 'Weather condition'},inplace = True) "
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "dataset.Visibility_km.mean() # Answer."
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# Q7: What is the Std deviation of Pressure ?"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "dataset['Rel Hum_%'].var() # when there is space in the column name we use [], if there is no space then, just '.' as shown."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "dataset['Weather condition'].value_counts() # snow was recorded 390 times."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# filtering\n",
    "\n",
    "dataset[dataset['Weather condition'] == 'Snow']"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# str.contains\n",
    "dataset[dataset['Weather condition'].str.contains('Snow')].tail(50)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "# by adding dataset[] we get the required output in non boolean.\n",
    "\n",
    "dataset[(dataset['Wind Speed_km/h'] > 24) & (dataset['Visibility_km'] == 25)]"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# only the conditions will give output in boolean.\n",
    "\n",
    "(dataset['Rel Hum_%'] < 90) & (dataset['Visibility_km'] == 25)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "dataset.groupby('Weather condition').mean() # Answer."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "dataset.groupby('Weather condition').min()"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "dataset.groupby('Weather condition').max()"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "# filtering\n",
    "\n",
    "dataset[dataset['Weather condition'] == 'Fog']"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "dataset[(dataset['Weather condition'] == 'Clear') | (dataset['Visibility_km'] > 40)]"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# Q15: Find all instances where Weather is clear and rel hum is greater than 50, or Visibility is above 40 ? "
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# Answer.\n",
    "\n",
    "dataset[(dataset['Weather condition'] == 'Clear') & (dataset['Rel Hum_%'] > 50) | (dataset['Visibility_km'] > 40)]"
   ]
  },
  {
   "cell_type": "code",
